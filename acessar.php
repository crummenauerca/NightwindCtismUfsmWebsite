              ...
              <div class="card-body text-left">
                ...
                <form method="post" action="./control/controleUsuario.php">
                  <div class="form-group">
                    ...
                    <input type="nome" class="form-control" placeholder="Nome" name="nome" id="nome" required="">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-secondary" name="opcao" value="Entrar">Acessar</button>
                  </div>
                </form>
              </div>
            </div>
