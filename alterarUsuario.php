...
<html>
  <head>
    ...
    <title>Nightwind - Gerenciar usuário</title>
  </head>
  <body>
        ...
        <div class="row">
          <div class="col-md-12">
            <?php 
              ...
              $codigo = $_GET["codigo"];
              $resultado = mostrarUsuarioAlterar($codigo);
              if ($resultado) {
            ...
            <div class="p-1">
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
                    <h2 class="mb-4">Editar um usuário</h2>
                    <form method="post" action="./control/controleUsuario.php">
                      <div class="form-group">
                        <label for="nome">Nome</label>
                        <input type="text" class="form-control" placeholder="Nome" name="nome" id="nome" required="" value="<?php echo $nome;?>">
                      </div>
                      <div class="form-group">
                        <label for="conteudo">Descrição do usuário</label>
                        <textarea class="form-control" required="" id="descricao" name="descricao" placeholder="Conteúdo do projeto"><?php echo $descricao; ?></textarea>
                      </div>
                      <div class="form-group">
                        <label for="senha">Senha (ATENÇÃO: A senha é criptografada! Deixe-a em branco para manter a senha anterior)</label>
                        <input type="password" class="form-control" placeholder="Deixe a senha em branco para manter a senha anterior" name="senha" id="senha">
                      ...
                      <div class="form-group">
                        ...
                        <fieldset>
                          <?php 
                            if ($tipo == "Administrador") {
                              echo '
                                <input type="radio" name="tipo" id="administrador" value="Administrador" checked>
                                <label for="administrador">Administrador</label><br/>
                                <input type="radio" name="tipo" id="colaborador" value="Colaborador">
                        ...
                        <a class="btn btn-secondary" href="./administrarUsuarios.php" style="margin: 10px">Cancelar</a>
                      </div>
                    </form>                    
                  </div>
                </div>
